...
myst_html_meta = {
    "description": "IP2Location Scala Library provides a fast lookup of geolocation information from IP address by using IP2Location database.",
    "keywords": "IP2Location, Geolocation, IP location, Scala",
...
html_title = "IP2Location Scala"

# html_baseurl = "https://ip2location-scala.readthedocs.io/en/latest/"